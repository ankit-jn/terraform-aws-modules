...
Refer [Configuration Examples](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-devops) for effectively utilizing this module.
...
- Refer `https://github.com/ankit-jn/terraform-aws-kms/blob/main/README.md` for the detailed info of the structure.
