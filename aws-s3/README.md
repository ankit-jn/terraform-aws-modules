...
Refer [Configuration Examples](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-s3) for effectively utilizing this module.
...
| <a name="policy_file"></a> [policy_file](#input\_policy\_file) | Policy File name with path relative to root directory if `attach_bucket_policy` is set `true`. | `string` | `""` | no | |
