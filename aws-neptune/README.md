## AWS Neptune, Graph Database Service - Terraform module
...
Refer [Configuration Examples](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-neptune) for effectively utilizing this module.
